...
## It also contains a handler to manage a request to 'resources/upload_dsrs', which presents the 
## user a form to select the data that the user would want to store into the DB. 

urlpatterns = [
    path('upload_dsrs/', views.UploadDsrFilesForm.as_view(), name='upload-dsrs'),
